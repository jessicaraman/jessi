...
<div class="container">
    ...
    <form:form method="POST" action="${pageContext.request.contextPath}/findAvailableByCreteria"
        ...
        <div class="row">
            <div class="col-md-3">
                <form:label data-error="champs invalide" path="date"
                            data-error="marque invalide">Date</form:label>
            ...
            <div class="col-md-3">
                <form:label path="start_time" data-error="heure invalide">Heure de début</form:label>
                <div class="input-group md-form form-sm form-2 pl-0">
            ...
            <div class="col-md-3">
                <form:label path="end_time" data-error="heure invalide">Heure de début</form:label>
                <div class="input-group md-form form-sm form-2 pl-0">
        ...
        <div class="row">
            <div class="text-left">
                <button type="submit" class="btn btn-primary" title="Lister les véhicules disponibles"><i class="fa fa-search"
                                                                                                          aria-hidden="true"></i>
                </button>
            </div>
        </div>
