        ...
        <div class="container">
            ...
            <form:form method="POST" action="${pageContext.request.contextPath}/car/updating" modelAttribute="car">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="input-group md-form form-sm form-2 pl-0">
                            <form:input title="AA-OO1-AA"
                                        onKeypress="if((event.keyCode < 48 || event.keyCode > 57) && (event.keyCode < 65 || event.keyCode > 90) && (event.keyCode < 97 || event.keyCode > 122)) event.returnValue = false;if((event.which < 48 || event.which > 57) && (event.which < 65 || event.which > 90) && (event.which < 97 || event.which > 122)) return false;"
                                        cssStyle="text-transform:uppercase"
                                        maxlength="7" type="text" path="registrationNumber" value="${car.registrationNumber}"
                    ...
                    <div class="col-md-4">
                        <div class="input-group md-form form-sm form-2 pl-0">
                            <form:input type="text" path="brandName" value="${car.brandName}" cssClass="form-control"/>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="input-group md-form form-sm form-2 pl-0">
                            <form:input type="text" value="${car.modelName}" path="modelName" cssClass="form-control"/>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="input-group md-form form-sm form-2 pl-0">
                            <form:input
                                    ...
                                    maxlength="6" type="text" path="kilometers" value="${car.kilometers}"
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group md-form form-sm form-2 pl-0">
                            <form:input type="date" path="releaseDate" value="${car.releaseDate}" cssClass="form-control"/>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="input-group md-form form-sm form-2 pl-0">
                            <form:input
                                    onKeypress="if(event.keyCode < 48 || event.keyCode > 57) event.returnValue = false;if(event.which < 48 || event.which > 57) return false;"
                                    maxlength="1" type="text" path="seatNumber" value="${car.seatNumber}"
                                    cssClass="form-control"/>
                    ...
                    <div class="col-md-4">
                        <div class="input-group md-form form-sm form-2 pl-0">
                            <form:input
                                    onKeypress="if(event.keyCode < 48 || event.keyCode > 57) event.returnValue = false;if(event.which < 48 || event.which > 57) return false;"
                                    maxlength="1" type="text" path="doorNumber" value="${car.doorNumber}"
                                    cssClass="form-control"/>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss=""><a
                            href="<c:url value="/car/" />">Annuler</a></button>
