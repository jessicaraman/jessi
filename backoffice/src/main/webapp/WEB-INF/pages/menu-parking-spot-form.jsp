...
<html>
    ...
    <body>
        ...
        <div class="container">
                            ...
                            <form:form method="POST" modelAttribute="parking" cssClass="m-5"
                                ...
                                <div class="md-form">
                                    ...
                                    <form:label class="custom-control custom-checkbox"
                                                path="plug">Prise pour voiture éléctrique</form:label>
                                </div>
                                ...
                                <div class="md-form">
                                    <i class="fa fa-tag prefix grey-text"></i>
                                    <form:input type="text" step="1" path="length" class="form-control"
                                                required="required"/>
                                    <form:label path="length">Dimension Place-length</form:label>
                                </div>

                                <div class="md-form">
                                    <i class="fa fa-tag prefix grey-text"></i>
                                    <form:input type="text" step="1" path="width" class="form-control"
                                                required="required"/>
                                    <form:label path="width">Dimension Place-width</form:label>
                                </div>


                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Annuler</button>
                                    <button type="submit" class="btn btn-primary"><i class="fa fa-plus mr-1"></i>Ajouter place
                                    </button>
                                </div>
                            </form:form>
                        </div>
                    ...
                    <div class="modal-content" style="width:650px;">
                        ...
                        <div class="modal-body">
                            ...
                            <form:form method="POST" modelAttribute="parking" cssClass="m-5"
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Annuler</button>
                                    <button type="submit" class="btn btn-primary"><i class="fa fa-plus mr-1"></i>Rechercher
                                        place
                                    </button>
                                </div>
                            </form:form>
            ...
            <%--@elvariable id="parkingSpot" type="java.util.List"--%>
            <c:if test="${!empty parkingSpot}">
                <table class="table table-hover">
                    <tr>
                        ...
                        <%--@elvariable id="place" type="fr.digicar.model.ParkingSpot"--%>
                    <c:forEach items="${parkingSpot}" var="place">
                        ...
                        <tr class="${cssClass}">
                            ...
                            <!-- Modal MODIFIER-->
                            <div class="modal fade mt-3" id="editModal" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content" style="width:650px;">
                                        ...
                                        <div class="modal-body">
                                                <%--@elvariable id="parking" type="fr.digicar.model.ParkingSpot"--%>
                                            <form:form method="POST" modelAttribute="parking"
                                                       action="/parking/edit/${place.id}">

                                                <div class="md-form">
                                                    <i class="fa fa-car prefix grey-text"></i>
                                                    <form:input type="number" path="nbSpot" class="form-control"
                                                                required="required"/>
                                                    <form:label path="nbSpot">Numéro de place</form:label>
                                                </div>
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="submit" class="btn btn-primary"><i
                                                            class="fa fa-plus mr-1"></i>Modifier place
                                                    </button>
                                                </div>
                                            </form:form>
